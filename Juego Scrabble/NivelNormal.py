    ...
    while True:
        ...
        if event == Comenzar:
          while tiempo_juego and letras_totales > 7:
                ...
                if turno== 1:
                    ...
                    if event== GuardarPartida:
                        ...
                        guardar_partida(nombre,'Normal',Tablero_Guardado,Atril_jugador,atril_m,Letras,letras_totales,puntaje_c,puntaje_j,'',tiempo,tiempo_guardado,start_time,cant_cambios)
                ...
                if turno == 0:        #turno maquina  
                    ...
                    lista_palabras=generar_palabras(atril_m,'Normal','')
                    cant=0
                    if lista_palabras:
          ...
          if tiempo_juego==False or letras_totales < 7:
                ...
                cargar_jugador(nombre,puntaje_j,'Normal')
    window.close()
