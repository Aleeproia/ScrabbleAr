...
def main(datos_guardados):
    ...
    GuardarPartida=' 'from Funciones import *
from Maquina import *
def main(datos_guardados):
    import  PySimpleGUI as sg
    import random
    ...
    Letras=datos_guardados['Letras']
    letras_totales=datos_guardados['Letras Totales']
    nivel=datos_guardados['Nivel']
    puntaje_c=datos_guardados['Puntaje Maquina']
    puntaje_j=datos_guardados['Puntaje Jugador']
    eleccion=datos_guardados['Eleccion']
    lista_puntajes=[]
    ...
    atril_m=datos_guardados['Atril Maquina']
    BotonAtrilNegro=r'./Images/Boton_Atril_Negro.png'
    Letra_M=r'./Images/Letra_M.png'
    Letra_A=r'./Images/Letra_A.png'
    Letra_Q=r'./Images/Letra_Q.png'
    ...
    cant_cambios=datos_guardados['Cantidad Cambios']
    ...
    for i in range(15):
        for j in range(15): #se da valores a los botones que queramos que tengan descuento o premios
            ...
            if((i==0)&(j==0))|((i==14)&(j==0))|((i==0)&(j==14))|((i==14)&(j==14))|((i==7)&(j==0))|((i==7)&(j==14))|((i==0)&(j==7))|((i==14)&(j==7)):
               if nivel =='Facil' or nivel == 'Normal':
                 window.find_element((i,j)).update(button_color=('black','#C34C47'),text='Px2')
               else: 
                   window.find_element((i,j)).update(button_color=('black','#C34C47'),text='P-5')
            ...
            if((i==3)&(j==0))|((i==11)&(j==0))|((i==6)&(j==2))|((i==8)&(j==2))|((i==0)&(j==3))|((i==7)&(j==3))|((i==14)&(j==3))|((i==2)&(j==6))|((i==6)&(j==6))|((i==8)&(j==6))|((i==12)&(j==6))|((i==3)&(j==7))|((i==11)&(j==7))|((i==2)&(j==8))|((i==6)&(j==8))|((i==8)&(j==8))|((i==12)&(j==8))|((i==0)&(j==11))|((i==7)&(j==11))|((i==14)&(j==11))|((i==6)&(j==12))|((i==8)&(j==12))|((i==3)&(j==14))|((i==11)&(j==14)):
                if nivel=='Facil' or nivel == 'Normal':
                    window.find_element((i,j)).update(button_color=('black','#98d6ea'),text='P-2')
                else:
                    window.find_element((i,j)).update(button_color=('black','#98d6ea'),text='L+2')
            ...
            if((i==5)&(j==1))|((i==9)&(j==1))|((i==1)&(j==5))|((i==5)&(j==5))|((i==9)&(j==5))|((i==13)&(j==5))|((i==1)&(j==9))|((i==5)&(j==9))|((i==9)&(j==9))|((i==13)&(j==9))|((i==5)&(j==13))|((i==9)&(j==13)):
               if nivel == 'Facil':
                 window.find_element((i,j)).update(button_color=('black','#2A9AAD'), text='Lx3')#a
                   ...
                   window.find_element((i,j)).update(button_color=('black','#2A9AAD'),text='Lx2')
               else:
                   window.find_element((i,j)).update(button_color=('black','#2A9AAD'),text='-LI')
            ...
            if((i==1)&(j==1))|((i==2)&(j==2))|((i==3)&(j==3))|((i==4)&(j==4))|((i==13)&(j==1))|((i==12)&(j==2))|((i==11)&(j==3))|((i==10)&(j==4))|((i==7)&(j==7))|((i==1)&(j==13))|((i==2)&(j==12))|((i==3)&(j==11))|((i==4)&(j==10))|((i==13)&(j==13))|((i==12)&(j==12))|((i==11)&(j==11))|((i==10)&(j==10)):
               if nivel == 'Facil':
                   window.find_element((i,j)).update(button_color=('black','#ffb385'),text='P-3')
               elif nivel == 'Normal':   
                   window.find_element((i,j)).update(button_color=('black','#ffb385'),text='P-5')#n
               else:
                   window.find_element((i,j)).update(button_color=('black','#ffb385'),text='P+4')
    ...
    while True:
        ...
        if event in (None,Terminar):
            break
        start_time = datos_guardados['Tiempo Comienzo'] + int(round(time.time() * 100)) - datos_guardados['Tiempo_Guardado']
        if event == Comenzar:
          pos=0
          for i in Tablero:
             ...
             pos=pos+1
          window.find_element('puntaje_j').update(puntaje_j)
          window.find_element('puntaje_c').update(puntaje_c)
          while tiempo_juego and letras_totales > 7:
                ...
                if tiempo_jugada==datos_guardados['Tiempo']:
                 tiempo_juego=False
                if event in (None,Terminar):
                    tiempo_juego=False
                if turno== 1:
                                    ...
                                    if (event[0] == (coordenada[0]+1))and(event[1] == coordenada[1]) and len(palabra)==2 and (window.find_element(event).get_text() not in Letras.keys()):
                                        ...
                                        if coor_y:
                                            ...
                                            if(event[0]==coordenada[0]) and (window.find_element(event).get_text() not in Letras.keys()):
                                                ...
                                                palabra=movimiento_incorrecto(window,palabra,ultima_letra,key_letras,BotonAtril)
                    if event == Comprobar:
                        if len(palabra)>2 and comprobar_palabra(palabra,nivel,eleccion):
                            puntaje_j+=comprobar_puntaje(palabra,coordenadas,Letras,coor_rojos,coor_naranja,coor_azul,coor_celeste, nivel)
                            ...
                            palabra_incorrecta(window,palabra,key_letras,coor_azul,coor_celeste,coor_naranja,coor_rojos,coordenadas,nivel,BotonAtril)     
                        puntaje_palabra=comprobar_puntaje(palabra,coordenadas,Letras,coor_rojos,coor_naranja,coor_azul,coor_celeste,nivel)
                    ...
                    if event == CAMBIARFICHAS:
                            ...
                            if nivel =='Dificil':
                                cambios=3
                            if (cant_cambios == cambios)|(cant_cambios > cambios):
                                devolver_l=0
                    ...
                    if event == GuardarPartida:
                        ...
                        guardar_partida(nombre,nivel,Tablero_Guardado,Atril_jugador,atril_m,Letras,letras_totales,puntaje_c,puntaje_j,eleccion,tiempo,tiempo_guardado,start_time)
                ...
                if turno == 0:        #turno maquina  
                    ...
                    lista_palabras=generar_palabras(atril_m,nivel,eleccion)
                    cant=0
                    if lista_palabras:
                        palabra_c=lista_palabras[random.randrange(0,len(lista_palabras))]
                        coordenadas_c=buscar_espacio(window,palabra_c,Tablero,Letras,nivel)
                        for l in palabra_c:
                            window[coordenadas_c[cant]].update(l.upper(), button_color=('Black','#D8C99B'))
                            cant+=1
                        puntaje_c+=comprobar_puntaje(palabra_c.upper(),coordenadas_c,Letras,coor_rojos,coor_naranja,coor_azul,coor_celeste,nivel)
          ...
          if tiempo_juego==False or letras_totales < 7:
                ...
                cargar_jugador(nombre,puntaje_j,nivel)
    window.close()
